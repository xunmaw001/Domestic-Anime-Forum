<template>
    ...
    <view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view v-if="index%6==0" @tap="onDetailTap(product)" class="list-item" :style='{"padding":"24rpx 0 0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"0 0 20rpx 0","borderColor":"red","backgroundColor":"rgba(98, 188, 203, 1)","borderRadius":"8rpx","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}'>
            ...
            <view :style='{"padding":"8rpx 0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"12rpx 0 0","borderColor":"red","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(98, 188, 203, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"36rpx","fontSize":"28rpx","borderStyle":"solid"}' class="title">{{product.yonghuzhanghao}}</view>
                                                                                                                                                                      </view>
                                        <view class="list-item-body" style="display: flex;flex-wrap: wrap;">
            <view :style='{"padding":"8rpx 0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"12rpx 0 0","borderColor":"red","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(98, 188, 203, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"36rpx","fontSize":"28rpx","borderStyle":"solid"}' class="title">{{product.yonghuxingming}}</view>
                                                                                                                                                                      </view>
		...
		<button :style='{"padding":"0","boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","margin":"20rpx auto","backgroundColor":"rgba(98, 188, 203, 1)","borderColor":"#409EFF","borderRadius":"80rpx","color":"#fff","borderWidth":"0","width":"80%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' v-if="userid && isAuth('yonghu','新增')" class="add-btn" @click="onAddTap()">新增</button>
